...
/**
 * Represents a chunk of text, it's location points and the character space width.
 */
public final class ExtractedWord {
   ...
   * @param startLocation {@link Point} start location of the text chunk
   * @param endLocation {@link Point} end location of the text chunk
