Git repository for the "DRC":http://www.spinfo.phil-fak.uni-koeln.de/forschung-drc.html project (Digital Romansch Chrestomathy), see our "development server":http://hydra4.spinfo.uni-koeln.de for downloads and data.
